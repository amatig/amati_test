...
public class CountDown extends MyScene {
	...
	public CountDown(LinkedList<Double> aListValue, LinkedList<Double> aOrderListValue) {
        ...
        // base
    	Shape ground = new Rectangle(0, BrainGameLite.CAMERA_HEIGHT, BrainGameLite.CAMERA_WIDTH, 0);
		Shape roof = new Rectangle(0, 70, BrainGameLite.CAMERA_WIDTH, 0);
		Shape left = new Rectangle(0, 0, 0, BrainGameLite.CAMERA_HEIGHT);
		Shape right = new Rectangle(BrainGameLite.CAMERA_WIDTH, 0, 0, BrainGameLite.CAMERA_HEIGHT);
    	...
    	Text look = new Text(37, 22, Resource.instance().fontCount, "Less to great");
