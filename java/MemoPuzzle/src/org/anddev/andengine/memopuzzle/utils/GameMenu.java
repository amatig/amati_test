...
public class GameMenu extends MenuScene {
	...
	public GameMenu() {
		...
		IMenuItem resetMenuItem = new ColorMenuItemDecorator(new TextMenuItem(MemoPuzzle.MENU_AUDIO, font, "AUDIO " + audio), 1.0f, 0.2f, 0.2f, 1.0f, 1.0f, 0.5f);
		resetMenuItem.setBlendFunction(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_SRC_ALPHA);
		addMenuItem(resetMenuItem);
		
		IMenuItem quitMenuItem = new ColorMenuItemDecorator(new TextMenuItem(MemoPuzzle.MENU_EXIT, font, "EXIT"), 1.0f, 0.2f, 0.2f, 1.0f, 1.0f, 0.5f);
