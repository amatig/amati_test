...
// in simulator we redefine to format for Prova Developer console
...
{\
	NSString * exceptionName = [@"org.prova." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.prova";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIProvaNativeItemNone = -1, 
	UIProvaNativeItemSpinner = -2,
	UIProvaNativeItemProgressBar = -3,
	
	UIProvaNativeItemSlider = -4,
	UIProvaNativeItemSwitch = -5,
	UIProvaNativeItemMultiButton = -6,
	UIProvaNativeItemSegmented = -7,
	
	UIProvaNativeItemTextView = -8,
	UIProvaNativeItemTextField = -9,
	UIProvaNativeItemSearchBar = -10,
	
	UIProvaNativeItemPicker = -11,
	UIProvaNativeItemDatePicker = -12,
	
	UIProvaNativeItemInfoLight = -13,
	UIProvaNativeItemInfoDark = -14,
	
	UIProvaNativeItemDisclosure = -15,
	
	UIProvaNativeItemContactAdd = -16
};
